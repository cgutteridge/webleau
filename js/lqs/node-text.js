...
LQS_NodeTypes['text'] = class LQS_Node_Text extends LQS_Node {
	...
	showEditView() {
		this.data.width = ((LQS.winWidth() /2))/this.lqs.layoutScale;
		this.data.height= ((LQS.winHeight()/2))/this.lqs.layoutScale;
		...
		this.dom.edit.textarea = $(`<textarea class="normal-paste" style="width:${this.data.width-30}px; height: ${this.data.height-80}px;"></textarea>`);
